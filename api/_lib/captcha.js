// hCaptcha / Cloudflare Turnstile server-side verification.
// Set CAPTCHA_SECRET + CAPTCHA_PROVIDER (hcaptcha | turnstile).
...
export async function verifyCaptcha(token) {
  ...
  if (!secret) {
    // Fail closed in production; allow during local dev if explicitly disabled.
