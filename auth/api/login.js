...
import { json, preflight, setSessionCookie, readBody } from "./_lib/http.js";
...
export default async function handler(req) {
  ...
  return new Response(JSON.stringify({ ok: true }), {
    ...
    headers: {
      ...
      ...(req.headers.get("origin") ? { "Access-Control-Allow-Origin": origin, "Access-Control-Allow-Credentials": "true" } : {}),
    },
  });
}
