# Palmshed site — design principles
...
3. **Typography over decoration.** Typography and spacing establish hierarchy. Decoration is kept to a minimum.
...
6. **Static by design.** One HTML page and a small sync script. No framework, no client-side logic, no external dependencies.
...
- Prefer short sentences. Prefer periods over commas when possible.
